    ...
    return (
        <>
            <div className="flex items-center mt-8 intro-y">
                <h2 className="mr-auto text-lg font-medium">Manage Inventory By Room</h2>
                <div className="w-full mt-3 sm:w-auto sm:ml-auto sm:mt-0">
                    <Link to={`/add-day-rates/hotel/${params.id}`}>
                            <Button variant="primary" className="mr-2 shadow-md">
                                Add Inventory By Hotel
                            </Button>
                    </Link>
                    <Link to="/vendor-hotel-inventory">
...
export default hotelInventoryRoomIndex;
