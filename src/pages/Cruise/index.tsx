...
import { fetchAllCruise, deleteCruise } from "./cruiseSlice";
...
const Main = ()=>{
  ...
  const handleDelete = (id: any) => {
    dispatch(deleteCruise(deleteValueRef.current));
    dispatch(fetchAllCruise());
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Manage Cruise</h2>
