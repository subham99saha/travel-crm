...
import { fetchAllState, deleteState } from "./StateSlice";
...
const Main = ()=>{
    ...
    const { data } = useAppSelector((state) => state.state);
  ...
  const handleDelete = (id: any) => {
    dispatch(deleteState(deleteValueRef.current));
    dispatch(fetchAllState());
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Manage State</h2>
        ...
        <div className="col-span-12 overflow-auto intro-y lg:overflow-visible">
          <Table className="border-spacing-y-[10px] border-separate -mt-2">
            ...
            <Table.Tbody>
              ...
              {data.length!==0 && _.take(data, data.length).map((item, Key) => (
