...
import { createState } from "./StateSlice";
...
const addState = ()=>{
  ...
  const schema = yup
    .object({
      stateName: yup.string().required().min(2),
    })
    .required();
  ...
  const onSubmit = async (event: React.ChangeEvent<HTMLFormElement>) => {
    ...
    if (!result) {
      ...
      let formData = {
        ...
        countryId: event.target[2].value,
        isActive: event.target[6].value,
       } ;

       //console.log("Fdata: ",event.target.length);
  ...
  return (
    <>
      <div className="flex items-center mt-8 intro-y">
        <h2 className="mr-auto text-lg font-medium">Manage State</h2>
      </div>
                    ...
                    <form className="validate-form" onSubmit={onSubmit}>
                      ...
                      <FormInput
                        ...
                        <FormInput
                          ...
                          name="stateName"
                          className={clsx({
                            "border-danger": errors.stateName,
                          })}
                          placeholder="State Name"
                        />
                        {errors.stateName && (
                          <div className="mt-2 text-danger">
                            {typeof errors.stateName.message === "string" &&
