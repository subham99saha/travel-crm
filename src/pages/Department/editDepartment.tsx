...
import { getDepartment, updateDepartment } from "./departmentSlice";
...
const editDepartment = ()=>{
  ...
  useEffect(()=>{
    dispatch(getDepartment(params.id));
  },[])
  
  const schema = yup
    .object({
      dptName: yup.string().required().min(2),
    })
    .required();
  ...
  return (
    <>
      <div className="flex items-center mt-8 intro-y">
        <h2 className="mr-auto text-lg font-medium">Manage Department</h2>
      </div>
                    ...
                    <form className="validate-form" onSubmit={onSubmit}>
                      ...
                      <FormInput
                        ...
                        <FormInput
                          ...
                          name="dptName"
                          className={clsx({
                            "border-danger": errors.dptName,
                          })}
                          placeholder="Currency"
                        />
                        {errors.dptName && (
                          <div className="mt-2 text-danger">
                            {typeof errors.dptName.message === "string" &&
