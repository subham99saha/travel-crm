...
import { fetchAllCurrency, deleteCurrency } from "./CurrencySlice";
...
const Main = ()=>{
  ...
  const handleDelete = (id: any) => {
    dispatch(deleteCurrency(deleteValueRef.current));
    dispatch(fetchAllCurrency());
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Manage Currency</h2>
