...
import { fetchAllVendor, deleteVendor } from "./vendorSlice";
import { useAppSelector, useAppDispatch } from "../../stores/hooks";
import { Link, useParams } from "react-router-dom";
import { format } from 'date-fns';

const massageBeautyTherapy = ()=>{
    ...
    useEffect(()=>{
      dispatch(fetchAllVendor('massage-beauty-therapy'));
  },[]);   
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Manage Vendor</h2>
...
export default massageBeautyTherapy;
