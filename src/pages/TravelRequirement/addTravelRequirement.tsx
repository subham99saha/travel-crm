...
import { createTravelRequirement } from "./TravelRequirementSlice";

const addTravelRequirement = ()=>{
  ...
  const onSubmit = async (event: React.ChangeEvent<HTMLFormElement>) => {
    ...
    if (!result) {
      ...
      let formData = {
       ...
       dispatch(createTravelRequirement(formData));
       reset({
        requirementType: "",
        isActive: "Y"
       });
...
export default addTravelRequirement;