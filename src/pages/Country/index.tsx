...
import { fetchAllCountry, deleteCountry } from "./CountrySlice";
...
const Main = ()=>{
  ...
  const handleDelete = (id: any) => {
    dispatch(deleteCountry(deleteValueRef.current));
    dispatch(fetchAllCountry());
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Manage Country</h2>
