...
import { fetchAllAirline, deleteAirline } from "./AirlineSlice";
...
const Main = ()=>{
  ...
  const handleDelete = (id: any) => {
    dispatch(deleteAirline(deleteValueRef.current));
    dispatch(fetchAllAirline());
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Manage Airline</h2>
