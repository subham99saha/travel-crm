...
const addEmployee = () => {
  ...
  const schema = yup
    .object({
      ...
      dateOfJoining: yup.date().required("Date of Joining is a required field"),
      ...
      enablePortalAccess: yup.boolean(),
      ...
      contributeToEmployeePensionScheme: yup.boolean().when("contributeToPF", {
        is: true,
        then: yup.boolean(),
      }),
      contributeToEmployeeStateInsurance: yup.boolean(),
      //medicalAllowance:yup.number(),
      contributeToProfessionalTax: yup.boolean(),
      hra: yup.number().required("CTC is required"),
      percentageOfCTC: yup.number().required("% of CTC is required"),
      hraPercentage: yup.number().required("HRA percentage is required"),
      // conveyanceAllowance: yup.number().required("Conveyance Allowance"),
      // fixedAllowance: yup.number().required("Fixed Allowance is required"),
      // costToCompany: yup.number().required("Cost To Company is required"),
    ...
    if (!result || payType.length == 0) {
      ...
      let formData = {
        ...
        costToCompany: parseFloat(
          12 *
            (totalCTC * (ctcPercentageState / 100.0) +
