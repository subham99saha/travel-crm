...
const editEmployee = ()=>{
  ...
  const [percentageOfCTC, setbasicSal] = React.useState(0);
  const [hraAmount, sethraAmount] = React.useState(0);
  ...
  const [costToCompany,setCostToComp] = React.useState(0);
  ...
  //   console.log(data)
  //   setbasicSal(data.percentageOfCTC);
  // },[])
   ...
   // const fetchData = async () => {
      ...
      //try {
        ...
        new Promise((resolve,reject)=>{
          resolve(dispatch(getEmployee(params.id)));
        }).then((res)=>{
          console.log(res.payload)
          setbasicSal(res.payload.percentageOfCTC);
        })
 ...
 //
 //setbasicSal(data.percentageOfCTC);
    // setEmployeeInHandSal(data.employeeInHand);
    // setGrossSal(data.grossSalary);
    // setEsiEmployerContribution(data.ESIEmployerContribution);
    // setEsiEmployeeContribution(data.ESIEmployeeContribution);
    // setEmployeePFContribution(data.employeePFContribution);
    // setEmployerPFContribution(data.employerPFContribution);
...
.object({
  ...
  empLastName: yup
    ...
    .min(2),
  empID: yup.string().required("Employee ID is a required field").min(2),
  empGender: yup.string(),
  department: yup.string(),
  workLocation: yup.string(),
})

const secondPageSchema = yup
.object({
  percentageOfCTC:yup.string().required(),
})


const thirdPageSchema = yup
.object({
...
const fourthPageSchema = yup
.object({
  salaryType: yup.string().required()
});

const providentFundSchema = yup
.object({
  contributeToPF: yup.string(),
  pfAccountNumber: yup.string().when("contributeToPF", {
    is: true,
    then: yup.string().required("PF Account Number is required"),
  }),
  uan: yup.string().when("contributeToPF", {
    is: true,
    then: yup.string().required("UAN is required"),
  }),
})
  ...
  const calculateGrossSal = () => {
    if(percentageOfCTC !== null){
      let data = parseInt(percentageOfCTC) - employeePFContribution - esiEmployeeContribution
      setGrossSal(data)
    }
  }

  const calculateInHandSal = () => {
    if(percentageOfCTC !== null){
      let data = parseInt(percentageOfCTC) - employerPFContribution - esiEmployerContribution
      setEmployeeInHandSal(data)
    }
  ...
  const calculateCostToCompany = () => {
    if(percentageOfCTC !== null){
      let data = parseInt(percentageOfCTC) 
      + parseInt(stockAmount) 
      + parseInt(telephoneExpence) 
      + parseInt(hraAmount) 
      + parseInt(carAmount) 
      + parseInt(medicalAllowance) 
      + parseInt(leaveTravelAllowance) 
      + parseInt(additionalBenefits)
      + parseInt(performanceIncentive)
      + parseInt(employerPFContribution)
      + parseInt(employeePFContribution)
      + parseInt(esiEmployeeContribution)
      + parseInt(esiEmployerContribution)
      setCostToComp(data)
    } else if(percentageOfCTC!==null){
      setCostToComp(percentageOfCTC)
    }
  ...
  const esiEmployee = () => {
    if(percentageOfCTC !== null)
    setEsiEmployeeContribution((percentageOfCTC * 0.75)/100)
  }

  const esiEmployer = () => {
    if(percentageOfCTC !== null)
    setEsiEmployerContribution((percentageOfCTC * 3.25)/100)
  }

  const pfEmployee = () => {
    if(percentageOfCTC !== null)
    setEmployeePFContribution((percentageOfCTC * 12)/100)
  }

  const pfEmployer = () => {
    if(percentageOfCTC !== null)
    setEmployerPFContribution((percentageOfCTC * 12)/100)
  }
              ...
              <div className="p-5">
                <Preview>
                  ...
                  <form
                    ...
                    onSubmit={currentState >= 2 ? onSubmit : null}
                  >
                    {currentState == 0 && (
                      <div>
                        {/* Employee Name */}
                    ...
                    the company */}
                        ...
                        <div className="flex justify-center mt-4">
                          ...
                          <div className="col-span-4 input-form pl-2 pr-2 w-1/2">
                          <FormLabel
                              htmlFor="validation-form-workLocation"
                              className="flex flex-col w-full sm:flex-row"
                            >
                      ...
                      <div>
                        ...
                        <div className="flex justify-between mt-10">
                          ...
                          <div className="input-form w-[25%] pl-[2%]">
                            <FormInput
                              type="number"
                              // className={clsx({
                              //   "border-danger": errors.basicSal,
                              // })}
                              placeholder={percentageOfCTC}
                              disabled
                            />
                            {/* {errors.basicSal && (
                              <div className="mt-2 text-danger">
                                {typeof errors.basicSal.message ===
                                  "string" && errors.basicSal.message}
                              </div>
                            )} */}
                          </div>
                        ...
                        <div className="flex justify-between mt-5">
                          ...
                          <div className="input-form w-[25%]">
                            ...
                            <FormInput
                              {...register("hraAmount")}
                              id="validation-form-hraAmount"
                              type="number"
                              name="hraAmount"
                              // className={clsx({
                              //   "border-danger": errors.hraAmount,
                              // })}
                            ...
                            {/* {errors.hraAmount && (
                              <div className="mt-2 text-danger">
                                {typeof errors.hraAmount.message ===
                                  "string" && errors.hraAmount.message}
                              </div>
                            )} */}
                          </div>
                        ...
                        <div className="flex justify-between mt-5">
                          ...
                          <div className="input-form w-[25%]">
                            ...
                            <FormInput
                              ...
                              placeholder={ (percentageOfCTC * 12)/100}
                              value={(percentageOfCTC * 12)/100}
                              onChange={(e) => {
                        ...
                        <div className="flex justify-between mt-5">
                          <div className="input-form flex items-center w-[28.5%]">
                            <h1 className="flex items-center">
                              ESI Employee Contrinution @0.75
                            </h1>
                          </div>
                          <div className="input-form w-[25%]">
                            {/* Number input for HRA Percentage */}
                        ...
                        <div className="flex justify-between mt-5">
                          ...
                          <div className="input-form w-[25%]">
                            ...
                            <FormInput
                              ...
                              value={(percentageOfCTC * 3.25)/100 }
                              onChange={(e) => {
                        ...
                        <div className="flex justify-between mt-5">
                          ...
                          <div className="input-form w-[25%]">
                            ...
                            <FormInput
                              ...
                              placeholder={ percentageOfCTC - employerPFContribution - esiEmployerContribution}
                              value= { percentageOfCTC - employerPFContribution - esiEmployerContribution}
                              onChange={(e) => {
