...
const addEmployee = () => {
  ...
  const [basicSal, setbasicSal] = React.useState(null);
  ...
  const [inHandSal , setInHandSal] = React.useState(0);
  ...
  //schema validation for each page
...
.object({
  ...
  const onSubmit = async (e) => {
    ...
    if (!result || payType.length == 0) {
      ...
      // schema
      // .validate(formData, { abortEarly: false }) // Ensure all errors are returned
      // .then(() => {
  ...
  const calculateGrossSal = () => {
    if(basicSal !== null){
      let data = parseInt(basicSal) - employeePFContribution - esiEmployeeContribution
      setGrossSal(data)
    }
  }
  ...
  const calculateInHandSal = () => {
    if(basicSal !== null){
      let data = parseInt(basicSal) - employerPFContribution - esiEmployerContribution
  ...
  const calculateCostToCompany = () => {
    if(basicSal !== null){
      ...
      setCostToComp(data)
    } else if(basicSal!==null){
      setCostToComp(basicSal)
    }
  ...
  const esiEmployee = () => {
    if(basicSal !== null)
    setEsiEmployeeContribution((basicSal * 0.75)/100)
  }

  const esiEmployer = () => {
    if(basicSal !== null)
    setEsiEmployerContribution((basicSal * 3.25)/100)
  }

  const pfEmployee = () => {
    if(basicSal !== null)
    setEmployeePFContribution((basicSal * 12)/100)
  }

  const pfEmployer = () => {
    if(basicSal !== null)
    setEmployerPFContribution((basicSal * 12)/100)
  }
      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        <div className="col-span-12 intro-y lg:col-span-12">
                          ...
                          <div className="input-form w-1/2 pl-2">
                            ...
                            <FormSelect
                              ...
                              className={clsx("border", {
                                ...
                                "border-gray-300": !errors.workLocation,
                              })}
                              onChange={(e) => {
                        ...
                        <div className="flex justify-center mt-4">
                          <div className="input-form w-full">
                            <FormInput
                              ...
                              className={clsx({
                                "border-danger": errors.residentialAddress2,
                              })}
                    ...
                    {currentState == 3 ? (
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          //let validate = [validateThirdPage(),validateFourthPage()]
                          // new Promise((resolve,reject) => {
                          //   console.log(currentState)
                          //   if(currentState == 0){
                          //     resolve(validateFirstPage())
                          //   } else if(currentState== 1){
                          //     resolve(validateSecondPage())
                          //   } else if(currentState== 2){
                          //     resolve(validateThirdPage())
                          //   } else if(currentState== 3){
                          //     resolve(validateFourthPage())
                          //   }
          ...
          >
            ...
            <div className="ml-4 mr-4">
              <div className="font-medium">Some Error occured,</div>
              <div className="mt-1 text-slate-500">
              Please check mandatory feild!
              </div>
            </div>
          </Notification>
