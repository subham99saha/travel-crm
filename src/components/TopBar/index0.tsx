    ...
    <>
      <div
        className={clsx([
          ...
          "after:content-[''] after:absolute after:inset-0 after:h-[80px] after:mx-3 after:bg-primary after:mt-5 after:rounded-xl after:shadow-md after:hidden after:md:block after:dark:bg-darkmode-600",
        ])}
      >
        <div className="flex items-center h-full">
          ...
          <div className="relative z-10 mr-48 mt-7">
            <div className="flex items-center">
              <div class="intro-y mx-1">
                <div class="px-4 py-1 mb-3 box zoom-in">
                  <div class="text-xl font-bold text-orange-400 rounded-full cursor-pointer ml-0 text-center">12</div>
          ...
          <Menu>
            <Menu.Button className="block w-10 h-10 overflow-hidden rounded-full shadow-lg image-fit zoom-in intro-x mt-4">
