    ...
    <>
      <div
        className={clsx([
          ...
          "after:content-[''] after:absolute after:inset-0 after:h-[100px] after:mx-3 after:bg-primary after:mt-5 after:rounded-xl after:shadow-md after:hidden after:md:block after:dark:bg-darkmode-600",
        ])}
      >
        <div className="flex items-center h-full">
          ...
          <div className="relative z-10 mr-48 mt-12">
            <div className="flex items-center">
              <div class="intro-y mx-1">
                <div class="px-4 py-2 mb-3 box zoom-in">
                  <div class="text-2xl font-bold text-orange-400 rounded-full cursor-pointer ml-0 text-center">12</div>
                  <div class="ml-0 mr-auto">
                    <div class="font-medium">All Leads</div>
                  </div>
                </div>
              </div>
              <div class="intro-y mx-1">
                <div class="px-4 py-2 mb-3 box zoom-in">
                  <div class="text-2xl font-bold text-orange-400 rounded-full cursor-pointer ml-0 text-center">12</div>
                  <div class="ml-0 mr-auto">
                    <div class="font-medium">New Leads</div>
                  </div>
                </div>
              </div>
              <div class="intro-y mx-1">
              ...
              <div class="intro-y mx-1">
                <div class="px-4 py-2 mb-3 box zoom-in">
                  <div class="text-2xl font-bold text-orange-400 rounded-full cursor-pointer ml-0 text-center">12</div>
                  <div class="ml-0 mr-auto">
                    <div class="font-medium">Potential</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Menu>
            <Menu.Button className="block w-12 h-12 overflow-hidden rounded-full shadow-lg image-fit zoom-in intro-x mt-8">
            <Lucide icon="User" className="w-full h-full mr-0 text-white" />
              {/* <img
                alt="Midone Tailwind HTML Admin Template"
            ...
            <Menu.Items className="w-56 mt-px relative bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
              <Menu.Header className="font-normal">
                <div className="font-medium">
                  {localStorage.getItem("userInfo") === null
                    ? ""
                    : JSON.parse(localStorage.getItem("userInfo"))["resData"][
                        "sName"
                      ]}
                </div>
              ...
              <Menu.Divider className="bg-white/[0.08]" />
              <Menu.Item className="hover:bg-white/5" onClick={() => logout()}>
